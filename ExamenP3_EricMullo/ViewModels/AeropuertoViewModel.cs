...
namespace ExamenP3_EricMullo.ViewModels
{
    public class AirportViewModel : INotifyPropertyChanged
    {
        ...
        private SoporteModel supportedAirport = new SoporteModel();
        ...
        public AeropuertoModel airport
        {
            get => _airport;
            set
            {
        ...
        public void SaveInSQLite()
        {
            if (airport != null)
            {
                ...
                bool validation = App._AeropuertoRepository.AddNewAirport(supportedAirport);
        ...
        public string ConvertToString(AeropuertoModel airport)
        {
